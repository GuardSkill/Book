	...
	<div id="login">
		...
		<form id="myForm" name="myForm" action="userAdd" method="post">
			<input name="user.uName" class="input1" required="required"
				...
				placeholder="密码" type="password" /> <input name="user.uEmail"
				required="required" placeholder="邮箱" type="text" /> <span
				class="show2"> <s:actionmessage />
			</span>
			<button class="but" type="submit">注册</button>
			<button class="but" onclick="window.location.href='login.jsp'">返回登录</button>
		</form>
	</div>
